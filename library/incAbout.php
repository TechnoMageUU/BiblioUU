            ...
            <tr>
                ...
                <td>
                    <?php 
                        ...
                        switch ($i) {
                            case 1:
                                echo "<img src='images/MargotAdlerImage01.jpg' width='200'>";
                                break;
                            case 2:
                                echo "<img src='images/MargotAdlerImage02.jpg' width='200'>";
                                break;
                            case 3:
                                echo "<img src='images/MargotAdlerImage03.jpg' width='200'>";
                                break;
                            case 4:
                                echo "<img src='images/MargotAdlerImage04.jpg' width='200'>";
                                break;
                            case 5:
                                echo "<img src='images/MargotAdlerImage05.jpg' width='200'>";
                                break;
                            case 6:
                                echo "<img src='images/MargotAdlerImage06.jpg' width='200'>";
                                break;
                            case 7:
                                echo "<img src='images/MargotAdlerImage07.jpg' width='200'>";
                                break;
                            case 8:
                                echo "<img src='images/MargotAdlerImage08.jpg' width='200'>";
                                break;                            
                        }
                    ?>
                </td>
          ...
          <tr>
                <td colspan="2">
                    <?php 
                        ...
                        echo "<div id='quotation'>";
                        echo $quoteText;
                        echo "<br />&nbsp;&mdash;Margot Adler";
                        echo '</div>';
                    ?>
                </td>
            </tr>
